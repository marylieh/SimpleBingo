...
class Updater(/* User-provided variables */ // Plugin running Updater
              ...
              private val type: UpdateType, // The provided callback (if any)
              private val callback: UpdateCallback?, // Whether to announce file downloads
              private val announce: Boolean
) {
    // The folder that downloads will be placed in
    private val updateFolder: File = plugin.server.updateFolderFile
    ...
    init {
        ...
        try {
            ...
            val message: String = if (createFile) {
